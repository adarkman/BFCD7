...
package body POSIX.Unsafe_Process_Primitives is
   ...
   function Fork return POSIX.Process_Identification.Process_ID is
      ...
      -- NT_Sec_Stack_Addr : System.Address := SSL.Get_Sec_Stack_Addr.all;
      -- NT_Exc_Stack_Addr : System.Address := SSL.Get_Exc_Stack_Addr.all;
      NT_Jmpbuf_Address : System.Address := SSL.Get_Jmpbuf_Address.all;
   begin
      Result := fork;
...
--! #        end if;
         ...
         --SSL.Set_Exc_Stack_Addr (System.Null_Address, NT_Exc_Stack_Addr);
